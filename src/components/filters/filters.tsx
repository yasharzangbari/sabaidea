        ...
        <Styled.DropDownContent>
          <Styled.DropDownItems>
            ...
            <Checkbox
              ...
              label={t(FILTER_ITEMS.SCIENCE_FICTION)}
            />
          </Styled.DropDownItems>
          <Styled.DropDownItems>
            <Checkbox
      ...
      <DropDown label={t("rateOfMovies")}>
        <Styled.DropDownItems>
          <Checkbox
            ...
            label={t(FILTER_ITEMS.HIGHEST_RATE)}
          />
          <Checkbox
            onChange={(event: ChangeEvent<HTMLInputElement>) =>
              handleFilters(event, QUERY_PARAMS.SORT)
            ...
            label={t(FILTER_ITEMS.LOWEST_RATE)}
          />
        </Styled.DropDownItems>
      </DropDown>
    </Styled.ContentWrapper>
